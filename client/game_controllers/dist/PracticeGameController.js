 ...
 * - Intelligent bot AI
 */
import { GameAction, GameStateEnum } from './types';
...
export class PracticeGameController {
    constructor(userId, userName) {
        ...
        // Demo settings
        this.DEMO_STARTING_CHIPS = 10000;
    ...
    handleAction(playerId, action, amount = 0) {
        ...
        // Process action
        const isAggressive = this.processAction(currentPlayer, action, amount);
    ...
    skipToShowdown() {
        ...
        while (this.communityCards.length < 5) {
            ...
            const nextState = this.stateMachine.getNextNormalState();
            if (nextState === GameStateEnum.Showdown)
                break;
            this.stateMachine.transition(nextState);
    ...
    handleShowdown() {
        ...
        // Determine winners
        const winners = HandEvaluator.determineWinners(activePlayers, this.communityCards, potStructure, 0.10 // 10% rake
        );
        // Award winnings
...
//# sourceMappingURL=PracticeGameController.js.map