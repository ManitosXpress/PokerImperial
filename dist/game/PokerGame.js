...
class PokerGame {
    constructor() {
        ...
        this.round = 'pre-flop';
        this.players = [];
        this.activePlayers = []; // Players currently in the hand
    ...
    getGameState() {
        ...
        return {
            ...
            currentTurn: (_a = this.activePlayers[this.currentTurnIndex]) === null || _a === void 0 ? void 0 : _a.id,
            dealerId: (_b = this.players[this.dealerIndex]) === null || _b === void 0 ? void 0 : _b.id,
            round: this.round,
        ...
        switch (action) {
            ...
            case 'bet':
                if (amount < this.currentBet)
                    throw new Error('Bet must be at least current bet');
    ...
    endHand(winner, handDescription) {
