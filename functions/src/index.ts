...
// Admin Functions
import { adminSetUserRole, adminMintCredits, getSystemStats, bootstrapAdmin, repairStuckSessions, getUserTransactionHistory, clearAllFirestoreData, adminDeleteUser } from './functions/admin';
...
export { repairStuckSessions, clearAllFirestoreData }; // HTTP Functions para reparación y limpieza
